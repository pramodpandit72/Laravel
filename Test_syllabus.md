## Laravel Form validation : CSRF field, Method field, Laravel Form validation, Validation Rules, Error Messages
...
Advanced Routing- Named Routes, Route Groups, Route Prefixing